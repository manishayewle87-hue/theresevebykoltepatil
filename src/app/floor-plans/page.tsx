        ...
        >
          ...
          <div className="lg:w-1/3 flex flex-col gap-4">
            <button 
              ...
              className={`text-left p-6 rounded-2xl border transition-all duration-500 ${activePlan === '3BHK' ? 'bg-gold-500/10 border-gold-500/50' : 'bg-white/[0.02] border-white/10 hover:border-white/30'}`}
            >
              <h3 className={`text-2xl font-light mb-2 ${activePlan === '3BHK' ? 'text-gold-400' : 'text-white'}`}>3 Bed Residence</h3>
              <p className="text-white/50 text-sm">Tower 05 — Type 02</p>
            </button>
            
            <button 
              onClick={() => setActivePlan('2BHK')}
              className={`text-left p-6 rounded-2xl border transition-all duration-500 ${activePlan === '2BHK' ? 'bg-gold-500/10 border-gold-500/50' : 'bg-white/[0.02] border-white/10 hover:border-white/30'}`}
            >
              <h3 className={`text-2xl font-light mb-2 ${activePlan === '2BHK' ? 'text-gold-400' : 'text-white'}`}>2 Bed Residence</h3>
          ...
          <div className="lg:w-2/3">
            <div className="aspect-[4/3] w-full bg-forest-950 rounded-3xl border border-white/10 relative overflow-hidden flex items-center justify-center group">
              ...
              <div className="relative z-10 text-center transition-all duration-500" key={activePlan}>
                ...
                >
                  ...
                  <p className="text-gold-500/80 text-sm uppercase tracking-widest mb-6">Detailed Schematic Pending</p>
