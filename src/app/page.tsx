...
export default function Home() {
  ...
  const textScale = useTransform(heroScroll, [0, 1], [1, 20]);
  const textOpacity = useTransform(heroScroll, [0, 0.5], [1, 0]);
  const videoScale = useTransform(heroScroll, [0, 1], [1.2, 1]);
  const overlayOpacity = useTransform(heroScroll, [0, 0.8], [0.6, 0.1]);
  ...
  return (
    <div className="relative bg-[#F5F5F5] text-[#0B2B1B] selection:bg-[#d4af37] selection:text-white">
      <Navbar />
      ...
      {/* 
        ...
        ========================================================================
      */}
      <div ref={heroRef} className="h-[200vh] relative w-full">
      ...
      {/* 
        ...
        ========================================================================
      */}
      <section ref={storyRef} className="relative h-[300vh] bg-white">
          ...
          <div className="relative z-10 max-w-5xl mx-auto text-center font-serif text-4xl md:text-6xl lg:text-7xl leading-[1.2]">
            ...
            <motion.div style={{ opacity: p3Opacity }} className="absolute inset-0 flex flex-col items-center justify-center mt-12">
              ...
              <div className="mt-16 flex flex-col sm:flex-row gap-6">
                <MagneticButton>
                  <div className="px-8 py-4 bg-[#0B2B1B] text-white font-sans tracking-[0.2em] uppercase text-xs font-bold rounded-full shadow-2xl hover:scale-105 transition-transform">
                    Book a Site Visit
                  </div>
                </MagneticButton>
                <MagneticButton>
      ...
      {/* 
        ========================================================================
        3. THE BENTO BOX AMENITIES GRID
        ========================================================================
      */}
      <section className="relative z-20 bg-[#F5F5F5] py-32 md:py-48 rounded-t-[4rem] -mt-12 shadow-[0_-20px_50px_rgba(0,0,0,0.05)]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 auto-rows-[300px]">
            ...
            >
              ...
              <div className="absolute bottom-0 left-0 p-10 md:p-12">
                <span className="font-sans text-[10px] tracking-[0.2em] uppercase text-white/70 block mb-2">Centerpiece</span>
                <h3 className="font-serif text-4xl md:text-5xl text-white mb-4">50,000 sq.ft. Club</h3>
                <p className="font-sans text-white/80 max-w-md font-light">An exclusive resident club featuring spa pavilions, infinity pools, and holistic wellness zones.</p>
              </div>
            </motion.div>
            ...
            <motion.div 
              ...
              className="md:col-span-1 md:row-span-2 relative rounded-[3rem] overflow-hidden group shadow-xl bg-white flex flex-col p-8 justify-between"
            >
              <div>
                <span className="font-serif text-6xl text-[#d4af37] block mb-4">50</span>
                <h3 className="font-serif text-3xl text-[#0B2B1B] mb-4">Acres of Greenery</h3>
                <p className="font-sans text-[#0B2B1B]/70 font-light">Sprawling curated greenery, bio-diverse parks, and serene walking trails right at your doorstep.</p>
              </div>
              <div className="relative h-64 w-full rounded-2xl overflow-hidden mt-8">
                <Image src="https://www.koltepatil.com/assets/uploads/gallery/1784787123820805146.jpg" alt="Greenery" fill className="object-cover group-hover:scale-110 transition-transform duration-[2s]" />
              </div>
            </motion.div>
            ...
            >
              <div className="absolute inset-0 z-0">
                <Image src="https://www.koltepatil.com/assets/uploads/gallery/17847870511644671891.jpg" alt="Smart Home" fill className="object-cover opacity-30 group-hover:opacity-60 transition-opacity duration-1000" />
            ...
            >
              <div className="relative z-10 w-full md:w-1/2">
                <h3 className="font-serif text-3xl md:text-4xl text-white mb-4">Global Standards</h3>
                <p className="font-sans text-white/70 text-sm font-light">Crafted with imported Italian marble, European fixtures, and bespoke minimalist finishing.</p>
              </div>
